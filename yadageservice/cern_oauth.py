...
oauth_app = oauth.register('oauth_app',
                           client_id=os.environ['CERN_OAUTH_APPID'],
                           client_secret=os.environ['CERN_OAUTH_SECRET'],
                           request_token_url=os.environ['CERN_OAUTH_TOKENURL'],
                           access_token_url=os.environ['CERN_OAUTH_TOKENURL'],
                           authorize_url=os.environ['CERN_OAUTH_AUTHORIZEURL'],
...
def init_app(app):
    ...
    global login
    global logout
    # oauth_redirect = oauth_app.authorize_access_token
